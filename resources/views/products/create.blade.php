...
@section('title', 'Ongeza Bidhaa')

@section('content')
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        <a href="{{ route('products.index') }}" class="text-emerald-600 font-bold text-sm">← Rudi</a>
        <h1 class="text-2xl font-black text-emerald-700">📦 Ongeza Bidhaa Mpya</h1>
    </div>
    ...
    <form method="POST" action="{{ route('products.store') }}" class="bg-white rounded-2xl shadow-card p-6 space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="col-span-2">
                <label class="block text-sm font-bold text-gray-600 mb-1">Jina la Bidhaa *</label>
            ...
            <div>
                <label class="block text-sm font-bold text-gray-600 mb-1">Kipimo (Unit) *</label>
            ...
            <div>
                <label class="block text-sm font-bold text-gray-600 mb-1">Bei ya Kununulia *</label>
            ...
            <div>
                <label class="block text-sm font-bold text-gray-600 mb-1">Bei ya Uziao *</label>
            ...
            <div>
                <label class="block text-sm font-bold text-gray-600 mb-1">Tarehe ya Kuisha</label>
        ...
        <div class="border-t border-gray-100 pt-4">
            <h3 class="font-black text-sm text-emerald-700 mb-3">Stoo ya Mwanzo (kwa kila tawi)</h3>
        ...
        <button type="submit" class="w-full btn-gold font-black py-3 rounded-xl">Hifadhi Bidhaa</button>
    </form>
</div>
@endsection
