  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-[76px]">
      ...
      <a href="#home" class="flex items-center gap-3 group">
        <span class="relative">
          <img src="{{ asset('favicon.png') }}" alt="{{ $appName }}"
      ...
      <div class="hidden lg:flex items-center gap-3">
        @guest
          @if (Route::has('login'))
            <a href="{{ route('login') }}" class="btn-ghost font-extrabold text-emerald-600 px-5 py-2.5 rounded-2xl border-2 border-emerald-200">Ingia</a>
          @endif
          @if (Route::has('register'))
            <a href="{{ route('register') }}" class="btn-gold font-extrabold px-6 py-3 rounded-2xl">Anza Bure</a>
          @endif
        @else
          <a href="{{ url('/home') }}" class="btn-ghost font-extrabold text-emerald-600 px-5 py-2.5 rounded-2xl border-2 border-emerald-200">Dashboard</a>
          <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit()" class="btn-gold font-extrabold px-6 py-3 rounded-2xl">Toka</a>
  ...
  <div id="mobileMenu" class="lg:hidden hidden bg-white/95 backdrop-blur-xl border-t border-gray-100 shadow-cardlg">
    <nav class="px-6 py-5 flex flex-col gap-1 font-extrabold text-emerald-700">
      ...
      <div class="flex gap-3 pt-3">
        @guest
          @if (Route::has('login'))
            <a href="{{ route('login') }}" class="flex-1 text-center btn-ghost font-extrabold text-emerald-600 px-5 py-3 rounded-2xl border-2 border-emerald-200">Ingia</a>
          @endif
          @if (Route::has('register'))
            <a href="{{ route('register') }}" class="flex-1 text-center btn-gold font-extrabold px-5 py-3 rounded-2xl">Anza Bure</a>
          @endif
        @else
          <a href="{{ url('/home') }}" class="flex-1 text-center btn-ghost font-extrabold text-emerald-600 px-5 py-3 rounded-2xl border-2 border-emerald-200">Dashboard</a>
          <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form-mobile').submit()" class="flex-1 text-center btn-gold font-extrabold px-5 py-3 rounded-2xl">Toka</a>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-14 items-center relative">
    ...
    <div>
      ...
      <div class="reveal mt-9 flex flex-wrap items-center gap-4" data-d="3">
        @guest
          @if (Route::has('register'))
            <a href="{{ route('register') }}" class="btn-gold font-black text-lg px-8 py-4 rounded-2xl inline-flex items-center gap-2">
              Anza Bure Leo
          ...
          @endif
        @else
          <a href="{{ url('/home') }}" class="btn-gold font-black text-lg px-8 py-4 rounded-2xl inline-flex items-center gap-2">
              Nenda Dashboard
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13 5l7 7-7 7M4 12h16"/></svg>
            </a>
        @endguest
...
<section id="huduma" class="py-24 bg-white relative">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-7">
      ...
      $features = [
        ['title'=>'POS ya Kasi ya Umema','desc'=>'Uza kwa sekunde — scan barcode kwa kamera ya simu, toa risiti kwa printer, SMS au WhatsApp.','icon'=>'pos','tint'=>'emerald'],
      ...
      @foreach($features as $i => $f)
        @php $tint = $f['tint']==='gold' ? 'bg-gold-50 border-gold-200' : 'bg-emerald-50 border-emerald-200'; @endphp
...
<section id="jinsi" class="py-24 bg-gradient-to-b from-emerald-50/60 to-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="reveal mt-14 text-center" data-d="3">
      @guest
        @if (Route::has('register'))
          <a href="{{ route('register') }}" class="btn-gold font-black text-lg px-9 py-4 rounded-2xl inline-flex items-center gap-2">
            Fungua Akaunti Sasa
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13 5l7 7-7 7M4 12h16"/></svg>
          </a>
        @endif
      @else
        <a href="{{ url('/home') }}" class="btn-gold font-black text-lg px-9 py-4 rounded-2xl inline-flex items-center gap-2">
            Nenda Dashboard
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13 5l7 7-7 7M4 12h16"/></svg>
          </a>
      @endguest
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-4 gap-10">
    <div class="md:col-span-2">
      <a href="#home" class="flex items-center gap-3">
        <img src="{{ asset('favicon.png') }}" alt="{{ $appName }}" class="h-12 w-12 rounded-2xl object-contain"
             onerror="this.style.display='none';this.nextElementSibling.style.display='grid';">
        <span id="footerLogoFallback" style="display:none"
              class="h-12 w-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-700 text-gold-400 font-black text-2xl grid place-items-center border-[3px] border-emerald-700">W</span>
        <span>
