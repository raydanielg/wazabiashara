...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        $secCards = [
            ...
            ['label'=>'Payments In','value'=>'TZS '.$fmt($stats['totalPaymentsIn']),'color'=>'sky','icon'=>'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z'],
            ['label'=>'Payments Out','value'=>'TZS '.$fmt($stats['totalPaymentsOut']),'color'=>'amber','icon'=>'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z'],
