...
<div class="space-y-5">
    ...
    <div class="flex items-center justify-between flex-wrap gap-3">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Manage categories for extra income transactions</p>
        </div>
    ...
    <form method="GET" class="flex gap-2 sm:gap-3 flex-wrap">
        <div class="relative flex-1 min-w-[180px]">
            ...
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Search income categories..." class="w-full pl-9 pr-3 py-2.5 rounded-2xl border border-gray-200 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 outline-none text-sm font-medium transition-all">
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50" id="catTableBody">
                    ...
                    <tr><td colspan="3" class="px-4 py-16 text-center">
                        ...
                        <p class="text-gray-400 font-medium text-sm">No income categories found. Add your first category!</p>
                    </td></tr>
                    @endforelse
                </tbody>
            </table>
...
<div id="catModal" class="fixed top-0 right-0 bottom-0 w-full sm:w-[420px] bg-white z-50 transform translate-x-full transition-transform duration-300 ease-out overflow-y-auto flex flex-col">
    ...
    <form id="catForm" class="flex-1 overflow-y-auto p-5 space-y-4">
        ...
        <div>
            ...
            <input type="text" name="name" id="catName" required placeholder="e.g. Rental Income" class="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 outline-none text-sm font-medium transition-all">
        </div>
