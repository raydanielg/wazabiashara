...
@section('page_title', 'Uhamisho wa Stoo')
...
<div class="space-y-5">
    ...
    <div class="flex items-center justify-between flex-wrap gap-3">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-0.5">Hamisha stoo kati ya tawi</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-gray-50 text-gray-500 font-semibold text-xs uppercase tracking-wide">
                    <tr>
                        <th class="px-4 py-3 text-left">Kutoka</th>
                        <th class="px-4 py-3 text-left hidden sm:table-cell">Kwenda</th>
                        <th class="px-4 py-3 text-center">Bidhaa</th>
                        <th class="px-4 py-3 text-center">Status</th>
                        <th class="px-4 py-3 text-left hidden md:table-cell">Ombi la</th>
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr><td colspan="7" class="px-4 py-16 text-center">
                        ...
                        <p class="text-gray-400 font-medium text-sm">Hakuna maombi ya uhamisho.</p>
                    </td></tr>
                    @endforelse
                </tbody>
            </table>
...
<div id="trfModal" class="fixed top-0 right-0 bottom-0 w-full sm:w-[480px] bg-white z-50 transform translate-x-full transition-transform duration-300 ease-out overflow-y-auto flex flex-col">
    ...
    <form method="POST" action="{{ route('stock-transfers.store') }}" class="flex-1 overflow-y-auto p-5 space-y-4">
        ...
        <div class="grid grid-cols-2 gap-3">
            <div>
                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Kutoka Tawi *</label>
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Kwenda Tawi *</label>
